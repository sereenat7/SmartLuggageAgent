    ...
    db.query(userSql, phoneVariants, (userErr, users) => {
      ...
      const bestAgentSql = `
        SELECT b.id, b.pickup_latitude, b.pickup_longitude, b.bag_weight,
               a.agent_id, a.latitude, a.longitude, a.h3_index, a.vehicle_type, a.max_weight_kg,
      ...
      db.query(bestAgentSql, [bookingId], (bestErr, rows) => {
        ...
        if (booking && userLat !== null && userLng !== null) {
          ...
          for (const row of rows) {
            ...
            let h3Distance = 8;
            try {
              const agentH3 = row.h3_index || latLngToCell(aLat, aLng, H3_RESOLUTION);
  ...
  db.query(query, (err, results) => {
    ...
    const activeSessionsQuery = `
      SELECT s.session_id, s.user_id, s.agent_id, s.start_time,
             ...
             b.airline_name, b.flight_number, b.additional_info, b.terminal, b.departure_city, b.arrival_city
