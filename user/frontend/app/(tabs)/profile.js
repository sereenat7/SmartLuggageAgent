...
const IP_ADDRESS = process.env.EXPO_PUBLIC_API_HOST || "192.168.0.127";
const API_URL = `${process.env.EXPO_PUBLIC_API_URL || 'http://192.168.0.127:5000'}/api/auth/user-profile`;
